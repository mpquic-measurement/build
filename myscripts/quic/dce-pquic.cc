...
int main(int argc, char *argv[]) {
    ...
    //system("wget -O files-0/ca-cert.pem --no-check-certificate http://213.239.214.178:5202/ca-cert.pem");
    //system("wget -O files-0/ca-key.pem --no-check-certificate http://213.239.214.178:5202/ca-key.pem");
    //system("wget -O files-0/README.txt --no-check-certificate http://213.239.214.178:5202/README.txt");
